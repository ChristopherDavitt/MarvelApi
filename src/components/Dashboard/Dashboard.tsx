      ...
      <Box sx={{display:'flex'}} >
        ...
        >
          <Toolbar sx={myStyles.toolbar}>
            ...
            <Button onClick={handleDialogClickOpen}>Create New Character</Button>

            {/*Dialog Pop Up begin */}
            <Dialog open={dialogOpen} onClose={handleDialogClickClose} aria-labelledby="form-dialog-title">
                <DialogTitle id="form-dialog-title">Add New Character</DialogTitle>
                <DialogContent>
                    <DialogContentText>Add A New Marvel Character</DialogContentText>
                    <MarvelForm />
                </DialogContent>
                <DialogActions>
            ...
            <Button sx={ myStyles.toolbar_button } onClick={handleDialogClickOpen}>Create New Character</Button>
          </Toolbar>
        </AppBar>
        <MUIDrawer
